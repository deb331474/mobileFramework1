...
import org.rahulshettyacademy.pageObjects.android.Mentor_Connect_LoginPage;
...
public class AndroidBaseTest extends AppiumUtils{
	...
	public Mentor_Connect_LoginPage mentor_Connect_LoginPage;
	...
	public void ConfigureAppium() throws IOException
	{
		...
		service = startAppiumServer(ipAddress,Integer.parseInt(port));
			...
			options.setApp(System.getProperty("user.dir")+"//src//test//java//org//rahulshettyacademy//resources//Mentor Connect_1.2.8_APKPure.apk");
			...
			//options.setApp(System.getProperty("user.dir")+"//src//test//java//org//rahulshettyacademy//resources//General-Store.apk");
			 ...
			 mentor_Connect_LoginPage=new Mentor_Connect_LoginPage(driver);
	}
